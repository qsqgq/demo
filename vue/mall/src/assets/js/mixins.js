...
export const searchMixin = {
  methods: {
    $_selectItem(keyword) {
      ...
      location.href = `https://s.m.taobao.com/h5?event_submit_do_new_search_auction=1&_input_charset=utf-8&topSearch=1&atype=b&searchfrom=1&action&from=1&sst=20&buying=buyitnow&q=${keyword}`;
    }
  }
};
